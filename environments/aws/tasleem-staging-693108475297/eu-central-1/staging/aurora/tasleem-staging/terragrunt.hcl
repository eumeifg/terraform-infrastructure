...
inputs = {
  ...
  db_subnet_group_name = "tasleem-staging"
  network_type         = "IPV4"
  ...
  db_cluster_parameter_group_name        = "tasleem-staging"
  db_cluster_parameter_group_family      = "aurora-mysql5.7"
  db_cluster_parameter_group_description = "Tasleem staging environment cluster parameter group."

  create_db_parameter_group      = true
  db_parameter_group_name        = "tasleem-staging"
  db_parameter_group_family      = "aurora-mysql5.7"
  db_parameter_group_description = "Tasleem staging environment cluster parameter group."
  ...
  iam_role_name       = "aurora-rds-monitoring-role-tasleem-staging"
