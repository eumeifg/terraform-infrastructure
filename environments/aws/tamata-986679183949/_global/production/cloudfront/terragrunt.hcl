...
dependency "prod_s3" {
  config_path = "../../../us-east-1/s3/tamata-static-assets-prod/"
}
...
terraform {
  source = "git::git@github.com:terraform-aws-modules/terraform-aws-cloudfront.git///?ref=v2.8.0"
}
...
inputs = {
  ...
  origin = {
    production = {
      domain_name = "k8s-tamataprod-9ac638d62b-163276299.eu-central-1.elb.amazonaws.com"
