...
inputs = {
  ...
  iam_assumable_roles_with_oidc_and_policies = {
    ...
    content-based-recommender = {
      role_name = "content-based-recommender-${dependency.eks.outputs.eks.cluster_id}"

      oidc_fully_qualified_subjects = ["system:serviceaccount:taza-dev:content-based-recommender"]

      iam_policy = {
        name   = "content-based-recommender-${dependency.eks.outputs.eks.cluster_id}"
