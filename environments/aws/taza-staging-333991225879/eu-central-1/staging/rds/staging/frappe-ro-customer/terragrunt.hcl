...
inputs = {
  identifier             = "taza-staging-frappe-ro-customer"
  ...
  parameter_group_name            = "taza-staging-frappe-ro-customer"
  ...
  monitoring_role_arn = dependency.master_frappe.outputs.enhanced_monitoring_iam_role_arn
