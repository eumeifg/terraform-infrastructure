...
dependency "acm" {
  config_path = "../../../us-east-1/acm/taza.iq/"
}
...
inputs = {
  ...
  comment = "Taza production Cloudfront"
  ...
  web_acl_id  = dependency.wafv2.outputs.web_acl_arn

  origin = {
    production = {
      domain_name = "k8s-tazaprod-7ff47c4b98-1451209285.eu-central-1.elb.amazonaws.com"
